...
public class CalendarView extends View implements View.OnTouchListener {
	...
	private int[] date = new int[42]; // 日历显示数字 // 当前显示的日历起始的索引
	private int curStartIndex, curEndIndex;
	// 给控件设置监听事件
	private OnItemCalendarClickListener onItemClickListener;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		surface.width = getResources().getDisplayMetrics().widthPixels*5/6;
		surface.height = (int) (getResources().getDisplayMetrics().heightPixels * 2/7);
	...
	private void calculateDate() {
		...
		Log.e(TAG, "curEndIndex:" + curEndIndex);
		// next month
	...
	// 给控件设置监听事件
	public void setOnItemCalendarClickListener(OnItemCalendarClickListener onItemClickListener) {
	...
	private class Surface {
		...
		public String[] weekText = { "周日", "周一", "周二", "周三", "周四", "周五",
				"周六" };
		public String[] monthText = { "1月", "2月", "3月", "4月", "5月", "6月",
		...
		public void init() {
			...
			monthPaint.setColor(Color.rgb(106, 181, 255));
			...
			weekPaint = new Paint();
			weekPaint.setColor(Color.rgb(106, 181, 255));
